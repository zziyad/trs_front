...
export default function FleetVAPPage() {
  ...
  const filteredVapps = vapps.filter(vapp => {
    const matchesSearch = 
      ...
      vapp.fleetNumber.toLowerCase().includes(searchTerm.toLowerCase()) ||
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        onChange={(e) => handleInputChange('fleetNumber', e.target.value)} 
                        required 
                      />
                    </div>
                    <div className="space-y-2">
                ...
                <TableBody>
                  {filteredVapps.map((vapp) => (
                    <TableRow key={vapp.id}>
                      ...
                      <TableCell>
                        <div className="font-mono">{vapp.fleetNumber}</div>
                      </TableCell>
                      <TableCell>
                        <div>
